...
![Sequence diagram for consents created and managed outside NoGi](http://www.plantuml.com/plantuml/proxy?cache=no&src=[https://raw.githubusercontent.com/jonashackt/plantuml-markdown/master/example-uml.iuml](https://raw.githubusercontent.com/norskgjeld/dokumentasjon-test/plantuml/docs/consent/plantuml_samtykke_sso.txt))
